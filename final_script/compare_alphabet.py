...
for i in range(0, len(longerArray) - len(shorterArray)):
	...
	print('', numerical_to_alphabet(truncatedArray), '\n', numerical_to_alphabet(shorterArray))
	alphabet_to_numerical(truncatedArray)
	alphabet_to_numerical(shorterArray)
	...
	print(' Penalty was:', penaltyCounter)
